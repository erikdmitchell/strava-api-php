...
class SegmentsApi
{
    ...
    protected function exploreSegmentsRequest($bounds, $activity_type = null, $min_cat = null, $max_cat = null)
    {
        ...
        if ($bounds !== null) {
            $queryParams['bounds'] = ObjectSerializer::toQueryValue($bounds, 'float');
        }
        // query params
        if ($activity_type !== null) {
            $queryParams['activity_type'] = ObjectSerializer::toQueryValue($activity_type, null);
        }
        // query params
        if ($min_cat !== null) {
            $queryParams['min_cat'] = ObjectSerializer::toQueryValue($min_cat, null);
        }
        // query params
        if ($max_cat !== null) {
            $queryParams['max_cat'] = ObjectSerializer::toQueryValue($max_cat, null);
        }
     ...
     * Star Segment
     *
     * @param  bool $starred starred (required)
     ...
     * @return \Swagger\Client\Model\DetailedSegment
     */
    public function starSegment($starred, $id)
    {
        list($response) = $this->starSegmentWithHttpInfo($starred, $id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\DetailedSegment, HTTP status code, HTTP response headers (array of strings)
     */
    public function starSegmentWithHttpInfo($starred, $id)
    {
        $returnType = '\Swagger\Client\Model\DetailedSegment';
        $request = $this->starSegmentRequest($starred, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function starSegmentAsync($starred, $id)
    {
        return $this->starSegmentAsyncWithHttpInfo($starred, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function starSegmentAsyncWithHttpInfo($starred, $id)
    {
        $returnType = '\Swagger\Client\Model\DetailedSegment';
        $request = $this->starSegmentRequest($starred, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function starSegmentRequest($starred, $id)
    {
